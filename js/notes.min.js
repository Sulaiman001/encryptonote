...
function resetBadge(){badgeCount=0;favicon.reset()}var init=function(){resetBadge();switch(getAction()){case "note":var a=getNoteId(),b=void 0!==getSecret()?getSecret():"";if(void 0===a||null===a)window.location="#/note/home/"+b;break;default:window.location.hash="#/note/home/"}};function getHashVars(){var a=window.location.hash,a=a.replace(/^#/,"");return a.split("/")}function getAction(){return getHashVars()[1]}function getNoteId(){return getHashVars()[2]}
function getSecret(){return getHashVars()[3]}$(document).ready(function(){init();$(window).on("hashchange",function(){init()});FastClick.attach(document.body);loadNote(getNoteId(),applyEditorEvents);$(document).bind("keydown","ctrl+s",function(){saveNote(CKEDITOR.instances.editor.getData())})});
